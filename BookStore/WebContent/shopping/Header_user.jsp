...
.nianhuo {
	...
	overflow: hidden;
	background: #e2191d
		url(//img30.360buyimg.com/da/jfs/t2578/129/1112557055/250910/53121bc/568cc10cNb5b4b7d9.jpg)
		no-repeat;
}

.nianhuo-big-pic, .nianhuo-small-pic {
	float: left;
	margin-top: 70px;
	overflow: hidden;
	_display: inline;
...
.zhaiban-nianhuo {
	width: 990px;
	background: #e2191d
		url(//img30.360buyimg.com/da/jfs/t2071/257/2001585217/222873/6506ec18/568e3727N6d79e2ca.jpg)
		no-repeat;
}

.zhaiban-nianhuo .nianhuo-small-pic {
	width: 416px;
}

.zhaiban-nianhuo .nianhuo-big-pic li, .zhaiban-nianhuo .nianhuo-small-pic li
	{
	margin-left: 7px;
}
</style>
...
<body>
		...
		<div class="w">
			...
			<ul class="fr">
				<li class="fore1" id="ttbar-login" clstag="h|keycount|2015|01b">
					...
					href="Register.jsp" class="link-regist style-red">免费注册</a> <%
 	} else {
 %> <a href="getAllUser.do?usereMail=${login.usereMail}"
					class="link-regist style-red">
					<label onmouseover="aa()" onmouseout="bb()">
				         ${login.usereMail}
					</label>
					</a> <%
 	}
 %>
				...
				<li class="fore2" clstag="h|keycount|2015|01c">
					<div class="dt">
						<a target="_blank" href="shopcar/index.html">我的订单</a>
					</div>
				</li>
				<li class="spacer"></li>
				<li class="fore3 dorpdown" id="ttbar-myjd"
					clstag="h|keycount|2015|01d">
					<div class="dt cw-icon">
						<i class="ci-right"><s>◇</s></i> <a target="_blank" href="#">BlueStore</a>
					</div>
				...
				<li class="fore4" clstag="h|keycount|2015|01e">
					<div class="dt">
						<a target="_blank" href="#">BooKStore会员</a>
					</div>
				</li>
				<li class="spacer"></li>
				...
				<li class="fore6 dorpdown" id="ttbar-apps"
					clstag="h|keycount|2015|01g">
					<div class="dt cw-icon">
						<i class="ci-left"></i> <i class="ci-right"><s>◇</s></i> <a
							target="_blank" href="#">手机BlueStore</a>
					</div>
				</li>
				<li class="spacer"></li>
				<li class="fore7 dorpdown" id="ttbar-atte"
					clstag="h|keycount|2015|01h">
					<div class="dt cw-icon">
						<i class="ci-right"><s>◇</s></i>关注 1
					</div>
					<div class="dd dorpdown-layer"></div>
				</li>
				<li class="spacer"></li>
				<li class="fore8 dorpdown" id="ttbar-serv"
					clstag="h|keycount|2015|01i">
					<div class="dt cw-icon">
				...
				<li class="fore9 dorpdown" id="ttbar-navs"
					clstag="h|keycount|2015|01j">
					<div class="dt cw-icon">
						<i class="ci-right"><s>◇</s></i>网站导航
					</div>
					<div class="dd dorpdown-layer"></div>
				</li>
				<li><a href="relogin.do" class="link-login"> <%
 	if (request.getSession().getAttribute("login") != null)
 %>注销
				</a></li>
			</ul>
	...
	<div class="w">
		...
		<div id="search-2014">
			...
			<form action="selectProduct.do"method="get">
				<input clstag="h|keycount|2015|03a" type="text" name="productName" class="text" />
				<input type="submit" value="搜索" class="button cw-icon">
				</form>
			</div>
		</div>
		<div id="settleup-2014" class="dorpdown" clstag="h|keycount|2015|04a">
			<div class="cw-icon">
				<i class="ci-left">111</i> <i class="ci-right">&gt;222</i> <a
					target="_blank" class="link-login" href="#">我的购物车</a>
			</div>
			...
			<div id="navitems-2014">
				...
				<ul id="navitems-group1">
					<li clstag="h|keycount|2015|06a" class="fore1"><a
						 href="Index.jsp"target="_blank">服装城</a></li>
					<li clstag="h|keycount|2015|06b" class="fore2"><a
						target="_blank" href="#">美妆馆</a></li>
					<li clstag="h|keycount|2015|06c" class="fore3"><a
						target="_blank" href="#">精品特卖</a></li>
					<li clstag="h|keycount|2015|06i" class="fore4"><a
						target="_blank" href="#">生鲜</a></li>
				</ul>
				<div class="spacer"></div>
				<ul id="navitems-group2">
					<li clstag="h|keycount|2015|06d" class="fore1"><a
						target="_blank" href="#">全球购</a></li>
					<li clstag="h|keycount|2015|06e" class="fore2"><a
						target="_blank" href="#">闪购</a></li>
					<li clstag="h|keycount|2015|06f" class="fore3"><a
						target="_blank" href="#">团购</a></li>
					<li clstag="h|keycount|2015|06g" class="fore4"><a
						target="_blank" href="#">拍卖</a></li>
					<li clstag="h|keycount|2015|06h" class="fore5"><a
